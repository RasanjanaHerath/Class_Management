...
const ClassManagement = () => {
  ...
  //       {Array.isArray(classesVerfied) && classes.map((classItem) => (
  //         <div
  //           key={classItem.id}
...
//         }
//       };
//       const response = await axios.get("http://localhost:3000/api/class/get-by-teacher", config);
//       setVerifiedClasses(response.data.verifiedClasses);
//       setPendingClasses(response.data.pendingClasses);
//     } catch (error) {
//       console.error("Error fetching classes:", error);
//     }
//   };
...
//         }
//       };
//       await axios.delete(`http://localhost:3000/api/class/delete/${id}`, config);
//       fetchClasses();
//     } catch (error) {
//       console.error("Error deleting class:", error);
//     }
...
//     if (classItem.isverify) {
//       navigate('/t_class_details', { state: { classId: classItem.id } });
//     }
//   };
